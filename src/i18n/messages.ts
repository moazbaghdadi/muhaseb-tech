...
const ar = {
  ...
  'modal.field.invoiceNumber': 'رقم الفاتورة (اختياري)',
  'modal.field.invoiceNumberPlaceholder': 'مثال: INV-2026-014',
...
const de: Record<keyof typeof ar, string> = {
  ...
  'modal.field.invoiceNumber': 'Rechnungsnummer (optional)',
  'modal.field.invoiceNumberPlaceholder': 'z. B. INV-2026-014',
...
const en: Record<keyof typeof ar, string> = {
  ...
  'modal.field.invoiceNumber': 'Invoice number (optional)',
  'modal.field.invoiceNumberPlaceholder': 'e.g. INV-2026-014',
